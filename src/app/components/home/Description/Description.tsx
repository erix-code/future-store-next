...
export default function Description() {
    ...
    const imageClass= (): string => {
        let className = "object-cover w-full h-5/6 xl:h-3/6 rounded shadow-light-shadow col-span-1 cursor-pointer";
        if (hasBorder){
            className += " border-4 border-pink-600";
        }
        return className;
    }
        ...
        <section className={"flex justify-center"}>
            <div className={"grid md:grid-cols-2 pt-32 w-9/12 lg:w-8/12   md:gap-x-24 grid-cols-1"}>
                <Image priority={false} quality={100}
                       ...
                       src={"/images/description.jpeg"} width={500} height={300} alt={"Product marketplace"}
